...
#         presentation_data = build_presentation_data(data, chart_base64,  enedis_chart_base64, comparatif_dto, request)
#
#         # 5️⃣ Render HTML
...
#
#
# def build_presentation_data(data, chart_base64, enedis_chart_base64, comparatif_dto, request):
